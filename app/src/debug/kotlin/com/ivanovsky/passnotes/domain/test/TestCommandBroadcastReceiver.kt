...
class TestCommandBroadcastReceiver : BroadcastReceiver() {

    private val parser = TestCommandParser()
    private val errorInteractor: ErrorInteractor by lazy { get() }
    private val interactor: TestCommandInteractor by lazy { get() }
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val message = processCommandResult.getOrThrow()
        Timber.d(message)
        showToast(context, message)
    }
