...
mod tests {
    ...
    const TEST_DATABASES: &[TestDatbase] = &[
        TestDatbase {
    ...
    #[test]
    fn should_return_error_when_key_is_invali() {
        // arrange
    ...
    fn should_encode_database() {
        for test_database in TEST_DATABASES {
            ...
            let expected = get_expected(&database);
    ...
    fn get_expected(source: &proto::Database) -> proto::Database {
        proto::Database {
    ...
    fn convert_key(key: &Key) -> proto::DatabaseKey {
        proto::DatabaseKey {
