...
if [ -n "$GPG_PASSPHRASE" ]; then
  ...
  gpg --passphrase $GPG_PASSPHRASE --yes --pinentry-mode loopback -o ./keys/keepassvault-firebase-service-account.json -d ./keys/keepassvault-firebase-service-account.json.gpg
  ...
  echo "d941da7369ffeb97fafe0211d56e761c62edfe05da008ed149798c6ba962cb0e *keys/keepassvault-firebase-service-account.json" | shasum --algorithm 256 --check
