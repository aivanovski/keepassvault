...
class DebugMenuInteractor(private val fileSystemResolver: FileSystemResolver,
	...
	fun newDbFile(password: String, file: FileDescriptor): OperationResult<Pair<FileDescriptor, File>> {
		val result = OperationResult<Pair<FileDescriptor, File>>()
	...
	private fun copyStreamToStream(inStream: InputStream,
								   outStream: OutputStream): OperationResult<Boolean> {
	...
	fun writeDbFile(inFile: File, outFile: FileDescriptor): OperationResult<Pair<FileDescriptor, File>> {
		val result = OperationResult<Pair<FileDescriptor, File>>()
