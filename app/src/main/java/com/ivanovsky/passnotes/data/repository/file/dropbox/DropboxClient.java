...
public class DropboxClient implements RemoteApiClient {
    ...
    @Override
    @NonNull
    public RemoteFileMetadata downloadFileOrThrow(String remotePath,
                                                  String destinationPath) throws RemoteFSException {
        FileMetadata result;
    ...
    @Override
    @NonNull
    public RemoteFileMetadata uploadFileOrThrow(String remotePath,
                                                String localPath) throws RemoteFSException {
        FileMetadata result;
